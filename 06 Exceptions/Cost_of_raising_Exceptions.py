...
# As we can see by the executions times the "code_3" is much faster because it does not raise an execption.# Think twice when you want to raise exceptions in functions, and see if you cant use an if statement instead
