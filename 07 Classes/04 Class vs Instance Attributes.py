...
class Point:
    point_color = "Red" # This is a class atribute, defined at the class level.
    # And they are the same across all instances of the class.

    def __init__(self, x, y, z): # "x, y, z" This are instance atributes. In other words these are attributes that belong to point instance or point objects.
         # every point object can have different values for this atributes.
        self.x = x
        self.y = y
        self.z = z
...
# But onLy this point will have this atribute
...
print(point_1.point_color) # We can use this object reference to get acess to the point color atribute (which is a default class atribute)
