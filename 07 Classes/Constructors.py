...
class Point:
    def __init__(self, x, y, z): # To create a constructor we call the magic method "__init__". 
        # "Self" is a reference to the current object, so we use self to set the atributes
