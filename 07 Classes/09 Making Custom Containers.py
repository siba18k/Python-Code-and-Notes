...
class TagCloud:
    def __init__(self): # For this example we are going to use a dictonary
        self.tags = {} # We are initializing an empty dictonary
    ...
    def __getitem__(self, tag): # Implmenting a magic method to get the value of a tag, if that tag does not exist it will return 0
