...
# numbers = [1,2]
# numbers.copy()
# All list objects in python have these methods that can be 
# A class is a blueprint for creating new objects 
x =1 
print(type(x))
# Everything in python is created using a class(Blue print for creating new objects)
...
# Class is a blueprint for creating
#  new objects
