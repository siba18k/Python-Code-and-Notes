...
print(string.ascii_letters) # this method will return a string with the alpahbet both in lower case and upper case. "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
print(string.digits) # this method will return a string with the number from 0 to 9. "0123456789"

password = "".join(random.choices(string.ascii_letters + string.digits, k=22)) # We use the ".join()" method with an empty string to join all the item of the selected list
print(password)
