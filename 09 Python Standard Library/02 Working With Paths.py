...
relative_path = Path(r"09 Python Standard Library\test_folder\test_file.py") # A relative path. In the current folder go to the subfolder "test_folder".

combine_path = Path(r"09 Python Standard Library\ 02 Working With Paths.py") / Path(r"test_folder") # We can use the "/" to combine path obejects.
...
dir_path = Path(r"Python_Standard_Library\Working_with_JSON.py")
print(dir_path.with_suffix(".txt"))
