...
message["from"] = "Sibahle Dube"
message["to"] = "sibahletanaka999@gmail.com"
message["subject"] = "Python email!"
message.attach(MIMEText("This is a python exclusive"))

with smtplib.SMTP_SSL(host="smtp.gmail.com", port=465) as smtp: #we need to create and open the SMTP and then close it. So it is better to use a "with" statment.
    ...
    smtp.login("sibahletanaka999@gmail.com", "")
